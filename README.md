...
- Puedes ver el código fuente de esta apliación [aquí](https://github.com/darioobg/Actividad3/blob/main/ConversorTemperaturas/src/main/java/ejemplo/conversortemperaturas/Temperature_converter.java).
#### 4. _Tip Calculator_
Sin modificaciones.
